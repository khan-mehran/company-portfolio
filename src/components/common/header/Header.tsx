...
export default function Example() {
  ...
  return (
    <div className="flex justify-center m-auto">
        <Disclosure as="nav" className="bg-light mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 rounded-2xl absolute top-10 w-full">
          {({ open }) => (
            <>
                          ...
                          <div className="flex space-x-4">
                            {navigation.map((item) => (
                              ...
                              className={classNames(
                                (item.href === currentPath) ? 'text-primary text-base': 'text-slate hover:text-primary font-medium text-base',
                                'rounded-md px-3 pt-2 pb-1 text-base font-medium relative',
                              )}
